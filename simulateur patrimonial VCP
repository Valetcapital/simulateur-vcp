/* =========================================================
   VALET CAPITAL PARTNERS — Simulateur patrimonial
...
(function(){
  ...
  // Masquer le contenu par défaut de la page pendant l'injection
        ...
        <div class="gate" id="gate">
          ...
          <form id="leadForm">
            ...
            <div id="step1">
              ...
              <div class="field">
                <label>Revenus annuels nets du foyer</label>
                <select id="revenus" required>
